                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl border border-border/60 bg-card p-3 space-y-2 text-xs">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      <ServiceChip icon={<Zap size={13} className="text-amber-500" />} label="Điện" value="Hunonic Smart" />
                      <ServiceChip icon={<Droplets size={13} className="text-sky-500" />} label="Nước" value="Theo đồng hồ" />
