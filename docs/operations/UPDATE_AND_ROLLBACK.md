...
- `[ ]` Runner thật tải artifact/source.
- `[ ]` Backup DB/env/source tự động trước update.
- `[ ]` Build/preflight thật.
- `[ ]` Switch active version và restart service thật.
